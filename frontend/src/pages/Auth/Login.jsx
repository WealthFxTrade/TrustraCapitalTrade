...
export default function Login() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error("System Error: Connection Refused.", { id: loadingToast });
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-[#020408] text-white flex items-center justify-center p-4 md:p-6 font-sans selection:bg-yellow-500/30 overflow-y-auto">
      ...
      <div className="w-full max-w-md space-y-6 md:space-y-8 py-10">
        ...
        <div className="text-center space-y-3 md:space-y-4">
          <div className="inline-flex p-3 md:p-4 bg-yellow-500/10 rounded-2xl md:rounded-3xl border border-yellow-500/20 shadow-2xl cursor-pointer" onClick={() => navigate('/')}>
        ...
        <div className="bg-[#0a0c10]/80 backdrop-blur-xl border border-white/5 rounded-[2rem] md:rounded-[3rem] p-6 md:p-10 shadow-3xl relative overflow-hidden">
          <form onSubmit={handleSubmit} className="space-y-5 md:space-y-6" noValidate>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group/input">
                ...
                <input
                  ...
                  className="w-full bg-black/40 border border-white/10 rounded-xl md:rounded-2xl py-3.5 md:py-4 pl-12 pr-12 text-sm focus:border-yellow-500/50 outline-none transition-all placeholder:text-gray-800"
                  placeholder="••••••••"
                />
            ...
            <button type="submit" disabled={loading} className="w-full py-4 md:py-5 bg-yellow-500 hover:bg-white text-black font-black rounded-xl md:rounded-2xl uppercase tracking-[0.2em] text-[10px] md:text-[11px] flex items-center justify-center gap-3 transition-all disabled:opacity-50">
