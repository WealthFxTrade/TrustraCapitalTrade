...
import {
  TrendingUp, Wallet, ArrowDownLeft, Zap, LayoutDashboard,
  FileText, History, Repeat, Globe, User, Clock, Menu, X, ArrowRight
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#05070a] text-white flex flex-col md:flex-row">
      ...
      <main className="flex-1 p-6 md:p-12 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-12">
          <Link
            to="/deposit"
            className="bg-blue-600 hover:bg-blue-500 p-6 rounded-[2rem]
            font-black text-xs uppercase tracking-widest flex items-center
            justify-center gap-3 transition-transform active:scale-95"
          >
          ...
          <Link
            to="/plans"
            className="bg-white text-black hover:bg-gray-100 p-6 rounded-[2rem]
            font-black text-xs uppercase tracking-widest flex items-center
            justify-center gap-3 transition-transform active:scale-95"
          >
