...
export default function StatCard({ title, value, trend, highlight }) {
  return (
    <div
      className={`glass-card p-6 border-l-2 transition-all duration-300 hover:bg-white/5 ${
    ...
    >
      ...
      <div className="flex items-end justify-between">
        <h3 className={`text-2xl font-black tracking-tight ${highlight ? 'text-yellow-500' : 'text-white'}`}>{value}</h3>
